...
public final class MockResponse implements Cloneable {
   ...
   * customhttp3.Protocol#HTTP_2}, this attaches a pushed stream to this response.
   */
   ...
   * customhttp3.Protocol#HTTP_2 HTTP/2}, this pushes {@code settings} before writing the response.
   */
