...
package customhttp3.mockwebserver;
...
import customhttp3.Headers;
import customhttp3.HttpUrl;
import customhttp3.Protocol;
import customhttp3.Request;
import customhttp3.Response;
import customhttp3.internal.Internal;
import customhttp3.internal.NamedRunnable;
import customhttp3.internal.Util;
import customhttp3.internal.http.HttpMethod;
import customhttp3.internal.http2.ErrorCode;
import customhttp3.internal.http2.Header;
import customhttp3.internal.http2.Http2Connection;
import customhttp3.internal.http2.Http2Stream;
import customhttp3.internal.http2.Settings;
import customhttp3.internal.platform.Platform;
import customhttp3.internal.ws.RealWebSocket;
import customhttp3.internal.ws.WebSocketProtocol;
import customio.Buffer;
import customio.BufferedSink;
import customio.BufferedSource;
import customio.ByteString;
import customio.Okio;
import customio.Sink;
import customio.Timeout;
import org.junit.rules.ExternalResource;

import static customhttp3.internal.Util.closeQuietly;
import static customhttp3.mockwebserver.SocketPolicy.CONTINUE_ALWAYS;
import static customhttp3.mockwebserver.SocketPolicy.DISCONNECT_AFTER_REQUEST;
import static customhttp3.mockwebserver.SocketPolicy.DISCONNECT_AT_END;
import static customhttp3.mockwebserver.SocketPolicy.DISCONNECT_AT_START;
import static customhttp3.mockwebserver.SocketPolicy.DISCONNECT_DURING_REQUEST_BODY;
import static customhttp3.mockwebserver.SocketPolicy.DISCONNECT_DURING_RESPONSE_BODY;
import static customhttp3.mockwebserver.SocketPolicy.EXPECT_CONTINUE;
import static customhttp3.mockwebserver.SocketPolicy.FAIL_HANDSHAKE;
import static customhttp3.mockwebserver.SocketPolicy.NO_RESPONSE;
import static customhttp3.mockwebserver.SocketPolicy.RESET_STREAM_AT_START;
import static customhttp3.mockwebserver.SocketPolicy.SHUTDOWN_INPUT_AT_END;
import static customhttp3.mockwebserver.SocketPolicy.SHUTDOWN_OUTPUT_AT_END;
import static customhttp3.mockwebserver.SocketPolicy.SHUTDOWN_SERVER_AFTER_RESPONSE;
import static customhttp3.mockwebserver.SocketPolicy.STALL_SOCKET_AT_START;
import static customhttp3.mockwebserver.SocketPolicy.UPGRADE_TO_SSL_AT_END;
