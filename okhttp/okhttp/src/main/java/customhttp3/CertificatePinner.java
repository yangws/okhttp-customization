...
import static customhttp3.internal.Util.equal;
 ...
 *   at customhttp3.CertificatePinner.check(CertificatePinner.java)
 *   at customhttp3.Connection.upgradeToTls(Connection.java)
 *   at customhttp3.Connection.connect(Connection.java)
 *   at customhttp3.Connection.connectAndSetOwner(Connection.java)
 * }</pre>
 *
