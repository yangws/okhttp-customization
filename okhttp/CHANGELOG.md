 ...
 *  New: Automatic module name of `customhttp3` for use with the Java Platform
    Module System.
...
package name from `com.squareup.okhttp` to `customhttp3`. This should make it
possible for large applications to migrate incrementally. The Maven group ID
is now `com.squareup.customhttp3`. For an explanation of this strategy, see Jake
...
`com.squareup.okhttp` package should upgrade to the `customhttp3` package. Libraries
